...
st.markdown("Generating columns")
column_gen(data)
data=cache(data)
...
st.sidebar.markdown("### Basic Plots for BP, BMI, Height and Weight Condition ")    
st.sidebar.markdown("### For BP Condition ")
bp_data=pd.read_csv('bp values.csv')
...
st.sidebar.markdown("### For Height Condition ")
...
st.sidebar.markdown("### For Weight Condition ")
...
st.sidebar.markdown("### For BMI Condition ")
